  ...
  const page = () => {
    ...
    return (
      <div>
        <BlogPage  title={blog.title} blogComments={blogComments} relatedBlogs={relatedBlogs} blogId={blog._id} blogContent={blog.content} bloggerName={blog.userData?.username} featuredImage={blog.featuredImage} blogDate={"21-11-2025"} userLogo={blog.userData.profilePic} />
      </div>
    )
  }
